...
+ Implement Target {#implement-target}
   ...
   + Client-side web: implement Target {#client-side}
      ...
      + [Adobe Experience Platform Web SDK](/help/c-implementing-target/c-implementing-target-for-client-side-web/help/c-implementing-target/c-implementing-target-for-client-side-web/aep-web-sdk.md)
