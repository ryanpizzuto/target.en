...
|August 6|[Auto-Target](/help/c-activities/auto-target/auto-target-to-optimize.md#how-long)|Updated text for the following FAQ: "How long should I wait for models to build?"|
...
|March 30|[Known issues and resolved issues](/help/r-release-notes/known-issues-resolved-issues.md#atjs)|Added a known issue that affects at.js versions prior to at.js 2.2.0. This issue caused click tracking to not report conversions in Analytics for Target (A4T) when Adobe Analytics code was not present on page elements.|
...
|March 13|[Limits](/help/r-troubleshooting-target/target-limits.md)|Updated the number of "Audiences, reusable per account."|
