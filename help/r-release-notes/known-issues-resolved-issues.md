...
* Criteria and Designs cards do not show the correct number of activities where they are being used. If the Criteria or Design is used in an AB Activity, the activity will not be taken into account and the card might show that the design/criteria is not used when in fact it is. 
