...
description: Learn how to use response tokens in Adobe Target output specific information to use in debugging and integrating with 3rd-party systems (such as Clicktale).
